---
episode_id: 638002df-dde2-4399-a295-fd3f9118337f
title: The New AI Org Chart
podcast_title: "The AI Daily Brief: Artificial Intelligence News and Analysis"
url: "https://pocketcasts.com/podcast/the-ai-daily-brief-artificial-intelligence-news-and-analysis/d41026a0-bb2a-013b-f3ee-0acc26574db2/the-new-ai-org-chart/638002df-dde2-4399-a295-fd3f9118337f"
played_date: 2026-04-12
played_at: "2026-04-12T12:00:00Z"
play_count: 1
duration_seconds: 1080
source: pocketcasts-history-browser
played_label: April 12
history_order: 23
...
The episode explores Jack Dorsey and Sequoia's Roelof Botha's argument that AI can replace traditional hierarchy by routing information through intelligence itself, with Block betting heavily on this "company as intelligence" model. The hosts examine this vision alongside real-world implementation at Every, where AI agents are already creating shadow organizational structures that bypass formal hierarchies. The central thesis is that organizations can shift from rigid management structures to dynamic intelligence-driven coordination.

For immediate action: read the foundational essay at block.xyz/inside/from-hierarchy-to-intelligence to understand the framework. If your organization is considering agent deployment, consult KPMG's "Agentic AI Untangled" paper (www.kpmg.us/Navigate) for a build-vs-buy-vs-borrow decision framework. Assess your organization's readiness through Superintelligent's Agent Readiness Audit (besuper.ai) to evaluate current capabilities against this intelligence-driven operating model.

## Transcript

Jack Dorsey and Sequoia's Roelof Botha published a sweeping essay arguing that AI can replace the information-routing function of hierarchy itself — and Block is betting the company on it. Today we read through their vision for the "company as intelligence," then compare it to the messy, bottom-up reality emerging at Every, where agents are already forming a shadow org chart.
Essay: https://block.xyz/inside/from-hierarchy-to-intelligence
Brought to you by:
